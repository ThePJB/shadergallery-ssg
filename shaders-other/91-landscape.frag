...
void main() {
      float h1 = 0.6 -0.3 * log(f1d(uv.x * 3.0 + time * 0.1));
      float h2 = 0.5 -0.2 * log(f1d(1238.0+(uv.x * 4.0) + (12238.0+time) * 0.2));
      float h3 = 0.4 -0.1 * log(f1d(7633.0+(uv.x * 5.0) + (55645.0+time) * 0.3));
