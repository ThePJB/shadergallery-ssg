...
void main() {
  ...
  vec2 warp_lf = cnoise2(vec3(uv_screen, time * 0.05));
  vec2 warp_hf = cnoise2(vec3(100.0 + uv_screen*10.0, time * 0.3));

  vec2 p = uv_screen + 0.3*warp_lf + 0.05*warp_hf;

  float h = 14.0*cnoise(vec3(p*3.0, time * 0.1));
